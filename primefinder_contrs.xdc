## Basys 3 Board Constraints for Prime Number Finder
## Compatible with Artix-7 XC7A35T-1CPG236C
...
## Additional timing constraints for optimization
set_max_delay -from [get_ports {sw[*]}] -to [all_registers] 15.0
set_max_delay -from [get_ports btn*] -to [all_registers] 15.0

## Optimize for speed
set_property OPTIMIZATION_MODE BALANCED [current_desi